...
public class Activator implements BundleActivator {
	...
	public void start(BundleContext context) throws Exception {
        ...
        if (verbose)
            System.err.println("[org.eclipse.equinox.weaving.springweaver] info Starting Spring LoadTimeWeaver service ...");
        ...
        java.util.Dictionary<String, String> properties = new Hashtable<String, String>();
        context.registerService(IWeavingServiceFactory.class, weavingServiceFactory, properties);
	}
